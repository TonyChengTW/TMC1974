...
sn=request("sn")
 ...
 'sql=" select  * from new where sn = """ & sn & """"
sql=" select  * from new where sn =" & sn 
'response.write sql
'response.end
 rs.Open Sql,conn
...
<a href="../index.html">Home</a>   >    <a href="../news.html">課程公告</a>   >    <span>2013.07.30會內會課程預告</span>
</div>
</div>
<div class="clear"></div>
<div id="mainframe">

<div class="page_title"><%  response.write  rs("title") %></div>
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0" style=" line-height:24px; color:#333;">
  <tr>
<td width="250" style=" background:url(../update/news/info_bg.jpg) left bottom; padding:40px 20px 0 20px"><h3></h3></td>
  </tr>
  <tr>
  <td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
  <td width="29%" align="center" bgcolor="#eeecde" style="color:#7e4300;border-top:3px solid #d2b23b;"><h4>日期</h4></td>
  <td width="71%" bgcolor="#eeeeee" style="border-top:3px solid #cfcfcf;">
  <p style=" padding-left:20px;"><strong><%  response.write  rs("sdate") %></strong></p></td>
      </tr>
    <tr>
      <td align="center" bgcolor="#f9f6e9" style="color:#7e4300;"><h4>熱力學堂</h4></td>
<td><p style=" padding-left:20px"><%  response.write  rs("content2") %></br><%  response.write  rs("head2") %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle1") %></td>
      </tr>
    <tr>
      <td align="center" bgcolor="#eeecde" style="color:#7e4300;"><h4>T.M.訓練<br />總評</h4></td>
      <td align="left" valign="middle" bgcolor="#eeeeee">
<p style=" padding-left:20px"><%  response.write  rs("content3") %></br><%  response.write  rs("head3") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle2") %></td>
    </tr>
    <tr>
      <td align="center" bgcolor="#f9f6e9" style="color:#7e4300;"><h4>教育訓練<br />
        講師</h4></td>
      <td><p style=" padding-left:20px"><%  response.write  rs("content4") %></br><%  response.write  rs("head4") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle3") %></td>
    </tr>
	<tr>
      <td align="center" bgcolor="#eeecde" style="color:#7e4300;"><h4>上課內容<br />
        簡介</h4></td>
      <td bgcolor="#eeeeee"><p style=" padding-left:20px"><%  response.write  rs("content1") %> </td>
    </tr>
    </table>
...
<br />
 ...
 <iframe src="https://www.google.com/calendar/embed?height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=toastmaster1974%40gmail.com&amp;color=%232952A3&amp;ctz=Asia%2FTaipei" style=" border-width:0 ; margin-left:30px; " width="910" height="600" frameborder="0" scrolling="no"></iframe>
