...
function Send_Date(Date_String,col)
{
  if (window.opener && !window.opener.closed)
        {
			col.value= (parseInt(Date_String.substring(0,4))-1911).toString()+Date_String.substring(4,Date_String.lenght);
			col.focus();
        }
 window.close();
}
...
<form method="post" action="date2.asp?col=<%=col%>" name="q1">
