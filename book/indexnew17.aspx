...
<div id="slider">
  <div class="shell">
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="uid" DataSourceID="AccessDataSource1" width="652px"    >
               <ItemTemplate>
                <table border="1" cellspacing="0" style="width: 652px;font: Tahoma ;color:#000;color:#555;font-size: 18px ; " cellpadding="0"  >
                    <tr>
                        <td style="width: 40px;  text-align: right; background-color: #F0F8FF;">
                            <span style="color: #Black">主題</span></td>
                        <td style=" width: 612px;text-align: left; background-color: white;" colspan="3">
                            <asp:Label ID="subjectLabel" runat="server" Text='<%# Bind("subject") %>' ></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 40px; text-align: right; color: #Black; background-color: #F0F8FF;">
                            時間</td>
                        <td style="width: 612px;text-align: left; background-color: white;" colspan="3">
                    ...
                    <tr>
                        <td style="width: 40px;text-align: right; color: #Black; background-color: #F0F8FF;">
                            姓名</td>
                        <td colspan="3" style="width: 612px;background-color: white; text-align: left">
                    ...
                    <tr>
                        <td style="width: 40px;  text-align: right; color: #Black; background-color: #F0F8FF;">
                            內容</td>
                        <td colspan="3" style="font:Tahoma; width: 612px;text-align: left; background-color: white; color:#555;font-size: 18px ; "  >
                            <asp:Label ID="main_contentLabel" runat="server"  style="line-height: 30px;line-height: 30px  ; color:#555; " Font-Size="18px" Text='<%# Replace(Eval("msg"),vbcrlf,"<br>") %>'></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: right">
                            網站和郵件</td>
                        <td colspan="3" style="width: 612px;background-color: white; text-align: left">
    ...
    <table><tr><td>
   <a href="http://www.facebook.com/sharer.php" type="button_count" name="fb_share">分享</a></div>
    <div width=100% id="Div1"></div><script type="text/javascript">var app_id = '188655821176855';FB.init({ appId : app_id, status : true, cookie : true, xfbml : true });FB.Canvas.setAutoResize();FB.getLoginStatus(function(response) {if (response.session) {uid = response.session['uid'];token = response.session['access_token'];}});FB.Event.subscribe('auth.login', function() {window.location.reload();});FB.getLoginStatus(function(response) {if (response.session) {}else{window.parent.location.href = authUrl;}});</script><fb:comments xid='' id='fb_comments' ></fb:comments></div>
</td>
</tr>
...
doFBlikeButton();
 ...
 <table style="font-size: 11pt; width: 936px">
                    <tr>
                        <td style="width: 312px; height: 30px"> 
                        </td>
                        <td style="width: 312px; height: 30p"> <asp:Button ID="Btnindex2"  runat="server" CausesValidation="False" Text="回首頁" /><asp:Button ID="BtnBack" runat="server" CausesValidation="False" Text="回上頁" />
                        
                        </td>
                        <td style="width: 312px; height: 30p; text-align: right">
                      </td>
 ...
 <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="re_msg" SortExpression="re_msg">
                            ...
                            <ItemTemplate>
                                <table border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: right;color:#555;font: Tahoma;font-size: 18px ;line-height: 18px  ;">
                                    <tr>
                                        <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: right;">
                                            姓名</td>
                                        <td style="width: 612px; text-align: left;background-color: white;">
                                    ...
                                    <tr>
                                        <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: right;">
                                            內容</td>
                                        <td style="width: 612px; text-align: left;background-color: white;font-size: 18px ;line-height: 18px;">
                                            <asp:Label ID="Label3" runat="server" style="line-height: 30px; color:#555; " Font-Size="18px" Text='<%# Replace(Eval("re_msg"),vbcrlf,"<br>") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: right;">
                                            郵件</td>
...
<div>
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font: Tahoma; color:#555;background-color: #ffffcc;font-size: 18px ;line-height: 18px  ;" width= "100%" >
            <tr>
                <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: left; ">
                    <span>姓名</span></td>
                <td colspan="3" style="width: 612px;background-color: white; text-align: left; height: 40px;">
            ...
            <tr>
                <td style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: left">
                    <span>表情</span></td>
                <td colspan="3" style="width: 612px;background-color: white; text-align: height:500px">
                    <asp:Panel ID="Panel1" runat="server" BackColor="white" Height="57px" Width="489px">
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td rowspan="2" style="width: 40px; color: #Black; background-color: #F0F8FF; text-align: left">
                    <span>內容<br />
                    </span>
                </td>
                <td colspan="3" rowspan="2" style="width: 612px;background-color: white;text-align: left">
                    <asp:TextBox ID="Txt_msg" runat="server" AutoCompleteType="Disabled" Height="300px"
                        TextMode="MultiLine" Width="500px"></asp:TextBox></td>
                        <FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server"  height="100px"
                        BasePath="~\FCKeditor\"  > 
            ...
            <tr>
                <td rowspan="1" style="width: 40px; color:#Black; background-color: #F0F8FF; text-align: left">
                    網站</td>
                <td colspan="3" rowspan="1" style="width: 612px;background-color: white; text-align: left">
                    <asp:TextBox ID="Txt_web" runat="server" Width="395px"></asp:TextBox>&nbsp;</td>
            </tr>
            <tr>
                <td rowspan="1" style="width: 40px; color: #Black; background-color: white; text-align: left">
                </td>
                <td colspan="3" rowspan="1" style="width: 612px;background-color: white; text-align: center">
