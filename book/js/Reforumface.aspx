...
<iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo urlencode(get_permalink($post->ID)); ?>&amp;layout=standard&amp;show-faces=true&amp;width=450&amp;action=like&amp;colorscheme=light" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; width:500px; height:60px"></iframe>
    ...
    <div style="text-align: center" title="健言社回覆討論">
        ...
        </span>&nbsp;<span style="font-size: 36pt"><strong><span style="color: #0000ff">健言社討論區回覆留言<br />
        <span style="font-size: 24pt">
