<%@ Page Language="VB" AutoEventWireup="false"  CodeFile="Reforumnew.aspx.vb" Inherits="Re_tmc "  validateRequest="false"  %>
...
<body>
    ...
    <div style="text-align: center" title="健言社回覆討論">
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="uid" 
            DataSourceID="AccessDataSource1" Width="80%" AllowPaging="True">
            <EditItemTemplate>
                uid:
            ...
            <HeaderTemplate>
                <strong><span style="font-size: 36pt; color: #0000ff">健言社討論區主題</span></strong>
            </HeaderTemplate>
        </asp:FormView>
        ...
        </span>&nbsp;<span style="font-size: 36pt"><strong><span style="color: #0000ff">健言社討論區回覆留言</span></strong><br />
        </span>
        <table border="1" cellpadding="0" cellspacing="0" style="font-size: 12pt; width: 80%;
            ...
            <tr>
                ...
                <td colspan="3" style="background-color: #ffffcc; text-align: left; height: 40px;">
                    <asp:TextBox ID="Txt_who" runat="server" Width="250px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                        ID="Requir_name" runat="server" ControlToValidate="Txt_who" ErrorMessage="請輸入姓名"></asp:RequiredFieldValidator></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" rowspan="1" style="background-color: #ffffcc; text-align: center">
                    <asp:Button ID="Btn_Add" runat="server" Text="新增" style="height: 21px" />
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/Tmc.mdb"
            SelectCommand="SELECT * FROM [talk] WHERE 1=1 or ([uid] = ?)">
            <SelectParameters>
