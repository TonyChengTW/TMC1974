    ...
    <table border="1" cellpadding="0" cellspacing="0"   style="width: 100%" >
            ...
            <tr style="font-size: 12pt">
                <td width="48%" 
                   ...
                   <marquee direction="up"  scrollamount="1"  align="midden" >
                    歡迎您來到健言留言版<br /><br /><br />
                ...
                <td width="40%" align="top"  style="width: 57%; background-color: #ffffcc; text-align: left">
...
健言社第121期留言數 新增留言
                ...
                <td width="12%" 
                    rowspan="4" align="top" style="width: 20%; background-color: #ffffcc; text-align: left">
            ...
            <tr style="font-size: 12pt">
                ...
                <td align="top"  style="width: 60%; background-color: #ffffcc; text-align: left">
<div  align="center">
      ...
      <a href="../index.asp" title="回網站首頁"></a><a href="../QA.html">報名Q&amp;A</a><br/>
                  </div>
...
<tr style="font-size: 12pt">
                ...
                <td align="center"  style="width: 60%; background-color: #ffffcc; text-align: left">
                 搜尋標題
        ...
        <tr>
	     <table border="1" cellpadding="0" cellspacing="0" style="width: 100%">
              ...
              <td style="width: 100%; background-color: #ffffcc; text-align: left">
                    <asp:Button ID="Btn_Add" Visible="False" runat="server" Text="新增" />
              <asp:Button ID="Btn2_Add" Visible="False" runat="server" Text="多媒體留言" />
			  <a href="./addForum.aspx" ><font size="5">新增留言</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <a href="./addForumNew.aspx"><font size="5">多媒體留言</font></a>
			  <a href="http://www.tmc1974.com/book/Reforum.aspx?uid=2605">
