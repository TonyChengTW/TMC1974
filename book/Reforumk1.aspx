...
document.write("<iframe src=\"http://www.facebook.com/plugins/like.php?href="+window.location.href+"&amp;layout=standard&amp;show_faces=true&amp;width=200&amp;action=like&amp;font=verdana&amp;colorscheme=light&amp;height=80\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:660px; height:60px;\" allowTransparency=\"true\"></iframe>");
                                ...
                                <table border="1" width="100%" cellpadding="0" cellspacing="0" style="text-align: right">
                                    ...
                                    <tr>
                                        <td style="width: 10%; color: #ffffff; background-color: green; text-align: right;">
                                            郵件</td>
                                        <td style="width: 90%; text-align: left;">
                                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("re_uid") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%; color: #ffffff; background-color: green; text-align: right;">
                                            網站</td>
