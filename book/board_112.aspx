...
<body style="text-align: center">
    ...
    <div>
        ...
        <strong><span style="font-size: 48pt; color: #3300ff; font-family: 標楷體">健言社討論區首頁</span></strong><br />
        <hr />
        <br />
        ...
        <asp:AccessDataSource ID="ADS_Insertboard" runat="server" 
            DataFile="~/App_Data/Tmc.mdb" SelectCommand="SELECT         COUNT(*) AS Expr1&#13;&#10;FROM             talk&#13;&#10;WHERE         (dcreate >= #6/01/2009#)"></asp:AccessDataSource>
        <asp:AccessDataSource ID="ADS_Reboard" runat="server" 
            DataFile="~/App_Data/Tmc.mdb" 
            
            SelectCommand="SELECT COUNT(*) AS Expr1 FROM talkRe WHERE (dcreate >= #6/01/2009#)">
        </asp:AccessDataSource>
        <table>
            <tr>
                <td>
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                        CellPadding="0" DataSourceID="ADS_Insertboard" GridLines="None" PageSize="1" 
                        ShowHeader="False" style="text-align: left" UseAccessibleHeader="False">
                        <Columns>
                            <asp:HyperLinkField Text="健言社第112期-新增留言" />
                            <asp:BoundField DataField="Expr1" ShowHeader="False" SortExpression="Expr1">
                                <FooterStyle Wrap="False" />
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" ForeColor="#3333FF" />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
                </td>
                <td>
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                        CellPadding="1" DataSourceID="ADS_Reboard" GridLines="None" PageSize="1" 
                        ShowHeader="False" style="text-align: left; margin-left: 0px" 
                        UseAccessibleHeader="False">
                        <Columns>
                            <asp:HyperLinkField Text="+&#160; 回覆留言" />
                            <asp:BoundField DataField="Expr1" ShowHeader="False" SortExpression="Expr1">
                                <FooterStyle Wrap="False" />
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" ForeColor="#3333FF" />
                ...
                <td>
                    =&nbsp;                     <asp:Label ID="Lab_Count" runat="server" style="color: #0000FF">0</asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
