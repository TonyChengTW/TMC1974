...
<div id="main">
  <div class="shell">
   <div class="leftfarme">  <h2>置頂文章</h2>
...
<asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="~/App_Data/Tmc.mdb"
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="uid"
            DataSourceID="AccessDataSource2" Width="80%" AllowPaging="True" CellPadding="4" ForeColor="#333333" 
GridLines="None" PageSize="50" ShowFooter="True">
            <Columns>
                <asp:BoundField DataField="who" HeaderText="姓名" SortExpression="who" >
                    <ItemStyle HorizontalAlign="Left" Width="100px" />
...
<div id="footer">
  <div class="shell">
    ...
    <p class="rf"><a href="http://www.tmc1974.com/book/indexnew.html">台北市健言社</a> by <a href="http://chocotemplates.com/">ChocoTemplates.com</a></p>
