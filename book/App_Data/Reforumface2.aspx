<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reforumface2.aspx.vb" Inherits="_Default" %>
...
doFBlikeButton();
            ...
            <span style="font-size: 12pt">&nbsp; &nbsp;&nbsp;<table style="font-size: 11pt; width: 100%">
                <tr>
                    ...
                    <td style="width: 100px; height: 19px; text-align: center"><a href="boardface2.aspx" target="_self"></a>
