<%@ Page Language="VB" AutoEventWireup="false" CodeFile="boardface2.aspx.vb" Inherits="Test" MaintainScrollPositionOnPostback="true" %>
...
<div  align="center">
            <a href="../index.html" title="回網站首頁">回網站首頁</a> 
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/boardcount.aspx" 
                        Target="_blank">117期1月留言排行</asp:HyperLink>
            ...
            <tr>
                <td style="width: 100%; background-color: #ffffcc; text-align: left">
                    <asp:Button ID="Btn_Add" runat="server" Text="新增主題" />
                     <asp:Button ID="Btn2_Add" runat="server" Text="多媒體留言" /><a href="http://www.tmc1974.com/book/Reforumface2.aspx?uid=2605">多媒體留言操作說明</a><blink><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Facebook臉書</sapn></blink>
                    <span><img src="../IMAGE/facebook3.jpg"></img><a href="http://www.facebook.com/group.php?gid=122596238214&amp;v=info&amp;ref=search" target="_blank"><img src="../IMAGE/facebook.jpg"></a></span>
    ...
    <asp:AccessDataSource ID="ADS_Reboard" runat="server" 
     ...
     <asp:AccessDataSource ID="ADS_boradcount" runat="server" DataFile="~/App_Data/Tmc.mdb"
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="uid"
            DataSourceID="AccessDataSource1" Width="80%" AllowPaging="True" CellPadding="4" ForeColor="#333333" 
...
GridLines="None" PageSize="50" ShowFooter="True">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="uid" DataNavigateUrlFormatString="Reforumface2.aspx?uid={0}"
