   ...
   <form id="form1" runat="server">
    <div style="text-align: center" title="健言社回覆討論">
        ...
        <span style="font-size: 24pt">
            <hr />
<iframe id="fbLike" scrolling="no" frameborder="0" src="" style="border: medium none; overflow: hidden; width: 450px; height: 65px;" allowtransparency="true"/>
<a href="http://www.facebook.com/sharer.php" type="button_count" name="fb_share">分享</a></iframe>
