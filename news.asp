...
<input alt="search" type="text" style="border: 0; width: 140px; margin-top: 5px; margin-left: 15px" id="GoogleKeyWord" name="GoogleKeyWord" size="20" onfocus="ClearKeyWord()" onblur="ClearKeyWord()" value="請輸入關鍵字..." />
...
<div id="topnavBg">
    <div class="navframe">
      <ul id="topnav" class="sf-menu">
        <li class="menu-item1"><a href="/aboutus.aspx"></a>
          <ul class="sub-menu">
<li id="menu-item-40"><a href="/about/societies.aspx">社團架構</a></li>
            <li id="Li1"><a href="/about/council.aspx">理監事會</a></li>
            <li id="Li2"><a href="/about/core_member.aspx">當期幹部</a></li>
            <li id="Li3"><a href="/about/leaders.aspx"><span style=" letter-spacing:-1px;">歷任理事長及社長</span></a></li>
            <li id="Li4"><a href="/about/faculty.aspx">師資介紹</a></li>
          </ul>
          <!--/sub-menu -->
        </li>
        <!--/本社簡介 -->
...
<ul class="sub-menu">
<li id="Li5"> <a href="/news.asp">課程公告</a></li>
<li id="Li6"> <a href="/event.asp">活動公告</a></li>
<li id="Li7"><a href="/gallery3.asp">活動剪影</a></li>
          </ul>
        </li>
        <!--/最新消息 -->
        <li class="menu-item3"><a href="/calendar.aspx"></a>
          <ul class="sub-menu">
            <li id="Li8"> <a href="/calendar.aspx">會內會課程</a></li>
            <li id="Li9"> <a href="/calendar/training_teacher.aspx">講師培訓課程</a></li>
            <li id="Li10"><a href="/calendar/OGA.aspx">奧瑞岡辯論課程</a></li>
            <li id="Li11"><a href="/calendar/50planning.aspx">50種課程規劃</a></li>
          </ul>
        </li>
        <!--/課程一欄表 -->
        <li class="menu-item4"><a href="/courseInfo.aspx"></a>
          <ul class="sub-menu">
            <li id="Li12"> <a href="/courseInfo.aspx">會內會流程</a></li>
            <li id="Li13"> <a href="/gallery2.asp">會內會照片</a></li>
            <li id="Li14"> <a href="/demotm.aspx">T.M.訓練影片</a></li>
          </ul>
        </li>
        <!--/週四會內會 -->
        <li class="menu-item5"><a href="/trains.aspx"></a>
          <ul class="sub-menu">
            <li id="Li15"> <a href="/trains.aspx">T.M.訓練</a></li>
            <li id="Li16"> <a href="/response/leader_trains.aspx">領導統御訓練</a></li>
            <li id="Li17"> <a href="/response/member_response.aspx">社友學習心得</a></li>
            <li id="Li18"> <a href="/response/download.aspx">課程講義</a></li>
          </ul>
        </li>
        <!--/學習資源 -->
        <li class="menu-item6"><a href="/join.aspx"></a>
          <ul class="sub-menu">
            <li id="Li19"> <a href="/join.aspx">加入健言社</a></li>
            <li id="Li20"> <a href="/QA.aspx">Q&A</a></li>
          </ul>
        </li>
        <!--/加入健言社 -->
...
'sql=" select top 3 * from new where category =2 order by CDate(releasedate) desc,cdate desc "
'sql=" select top 3 * from new order by sn DESC " 
sql="select top 5 * from new where category =2 and (startdate<=now()) And (enddate>=now()) order by CDate(releasedate) desc,sdate desc "
sql="SELECT  top 15 * FROM new WHERE category=10  ORDER BY new.sdate DESC"
'response.write sql
'response.end
rs.Open Sql,conn
%>
...
<tr><td width="195" rowspan="3" align="left" valign="top">
<a href="/news/news_info.asp?sn=<% response.write rs("sn") %>" target="_blank">



<img src=<% =link %> width="195" height="150" /></a></td>
<% 'response.write rs("coverLink")  %>
<td><h3><a href="/news/news_info.asp?sn=<% response.write rs("sn") %>" target="_blank"><% response.write rs("title") %></a></h3></td></tr><tr><td>
<p><span><% response.write rs("title") %></span></td>
</tr><tr><td valign="top">
<p>熱力學堂：<% =content2 %>&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("head2") %>
<p><% response.write rs("htitle1") %>
<p>TM：<% =content3 %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("head3") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle2") %>
<p>教育訓練：<% =content4  %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =head4  %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle3") %>
  </p></td>
</tr></table><!-- 2013 08 17-->
<% rs.movenext %>
<% wend 
