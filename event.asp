...
sql="SELECT  top 10 * FROM new WHERE category=12  ORDER BY new.sdate DESC"
'response.write sql
'response.end
rs.Open Sql,conn
%>
...
<a href="index.asp">Home</a>   >    <span>活動公告</span>
</div>
</div>
<div class="clear"></div>
<div id="mainframe">

<div class="page_title">活動公告</div>
...
<a href="/news/event_info.asp?sn=<% response.write rs("sn") %>" target="_blank">



<img src=<% =Poster%> width="195" height="150" /></a></td>
<% 'response.write rs("Poster")  %>
<td><h3><a href="/news/event_info.asp?sn=<% response.write rs("sn") %>" target="_blank"><% response.write rs("title") %></a></h3></td></tr><tr><td>
<p><span><% response.write rs("title") %></span></td>
</tr><tr><td valign="top">
<p><% =content2 %>&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("head2") %>
<p><% response.write rs("htitle1") %>
<p><% =content3 %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("head3") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle2") %>
<p><% =content4  %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =head4  %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% response.write rs("htitle3") %>
  </p></td>
</tr></table><!-- 2013 08 17-->
<% rs.movenext %>
<% wend 
