...
HasPermission("news")	'有發生錯誤也不會停止
	...
	Dim category,title,releasedate,startdate,enddate,hintpic,content1, content2
...
ISQL = "INSERT INTO new (category,title,releasedate,startdate,enddate,hintpic,content1,pic1,pic2,pic3,content2,nfile) "
ISQL = ISQL& " Values ("& category &",'"& title &"','"& releasedate &"','"& startdate &"','"& enddate &"','"& hintpic &"','"& content1 &_
       "','"& pic1 &"','" & pic2 &"','"& pic3 &"','"& content2 &"','"& nfile &"')"
