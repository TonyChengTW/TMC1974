...
ISQL = "INSERT INTO new (category,title,releasedate,startdate,enddate,sdate,hintpic,content1,pic1,pic2,pic3,content2,content3,content4,head1,head2,head3,head4,coverLink,htitle1,htitle2,htitle3, nfile) "
ISQL = ISQL& " Values ("& category &",'"& title &"','"& releasedate &"','"& startdate &"','"& enddate &"','"& sdate &"','"& hintpic &"','"& content1 &_
       "','"& pic1 &"','" & pic2 &"','"& pic3 &"','"& content2 &"','"& content3 &"','"& content4 &"','"& head1 &"','"& head2 &"','"& head3 &"','"& head4 &"','"& coverLink &"', '"& htitle1 &"', '"& htitle2 &"', '"& htitle3 &"','"& nfile &"')"
