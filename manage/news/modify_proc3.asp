...
USQL = USQL&",hintpic='"& hintpic &"',content1='"& content1 &"',content2='"& content2 &"',content3='"& content3 &"',content4='"& content4 &"',head1='"& head1 &"',head2='"& head2 &"',head3='"& head3 &"',head4='"& head4 &"', pic1='"& pic1 &"',pic2='"& pic2 &"',pic3='"& pic3 &"',coverLink='"& coverLink &"',htitle1='"& htitle1 &"',htitle2='"& htitle2 &"',htitle3='"& htitle3 &"',nfile='"& nfile &"',mdate='"&GetDate()&"'  where sn="&sn
