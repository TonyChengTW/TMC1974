...
'	next
	...
	if ErrDescription = "" or isnull(ErrDescription) then
		...
		Dim category,title,releasedate,startdate,enddate,hintpic,head1,content1,head2,content2,head3,content3
		'讀取資料
...
'		Next
		...
		USQL = USQL&",hintpic='"& hintpic &"',content1='"& content1 &"',pic1='"& pic1 &"',pic2='"& pic2 &"',pic3='"& pic3 &"',nfile='"& nfile &"',mdate='"&GetDate()&"'  where sn="&sn
