...
'sql=" select top 10 * from new where category =8 order by CDate(releasedate) desc,cdate desc "
sql=" SELECT TOP 10  * FROM new WHERE (((new.[category])=10)) and (((new.nfile) <>'')) ORDER BY new.sdate DESC"
...
<a href="index.asp">Home</a>   >    <a href="news.html">會內會</a>   >    <span>會內會照片</span>
</div>
</div>
<div class="clear"></div>
<div id="mainframe">

<div class="page_title">會內會照片</div>
<table width="960" border="0" cellspacing="0" cellpadding="0" style=" color:#333; line-height:21px; padding-left:10px">
...
<% JpgSrc= rs("coverLink")     %>
<tr>
  <td style="border-bottom:1px dashed #999; padding-bottom:15px">
    <div class="gallerybox">
      ...
      <a href=<%=link %>  target="_blank"> 
        <img src=<%=JpgSrc %> width="200" height="150" />
      </a>

      <!--
      <h2>
        <a href=<%=link %>  target="_blank"><%=title %></a>
        <p><a href=<%=link %>  target="_blank"><%= rs("content2") %></a></p>
        <p><a href=<%=link %>  target="_blank"><%= rs("content3") %></a></p>
        <p><a href=<%=link %>  target="_blank"><%= rs("content4") %></a></p>
      </h2>
      <a href=<%=link %>  target="_blank"> 
        <img src=<%=JpgSrc %> width="200" height="150" />
      </a>
...
<% JpgSrc= rs("coverLink")     %>
    ...
    <!--
      <h2>
        <a href=<%=link %>  target="_blank"><%=title %></a>
        <p><a href=<%=JpgSrc %>  target="_blank"><%=title %></a></p>
      </h2>
      <a href=<%=link %>  target="_blank"> 
        <img src=<%=JpgSrc %> width="200" height="150" />
      </a>
