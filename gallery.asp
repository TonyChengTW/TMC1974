...
sql=" select top 10 * from new where category =7 order by CDate(releasedate) desc,cdate desc "
 rs.Open Sql,conn
%>
<div class="maintop">
<div class="breadcrumb">
<a href="index.asp">Home</a>   >    <a href="news.html">最新消息</a>   >    <span>活動剪影</span>
</div>
</div>
<div class="clear"></div>
<div id="mainframe">

<div class="page_title">活動剪影</div>
...
<% title= rs("title")     %>
<% JpgSrc= rs("content2")     %>
<tr><td style="border-bottom:1px dashed #999; padding-bottom:15px"><div class="gallerybox">

<h2><a href=<%=link %>  target="_blank"><%=title %></a>

  <p><a href=<%=link %>  target="_blank"><%=title %></a></p>
</h2>
<a href=<%=link %>  target="_blank"> <img src=<%=JpgSrc %> width="200" height="150" /></a>
</div>
<% rs.movenext %>
<% link= rs("nfile")     %>
<% title= rs("title")     %>
